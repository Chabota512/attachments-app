    ...
    <View style={[s.screen, { paddingTop: topPad }]}>
      ...
      <View style={s.header}>
        <View>
          ...
          <Text style={s.subtitle}>Opportunities near you</Text>
        </View>
        <Pressable
...
const styles = (colors: ReturnType<typeof useColors>) => StyleSheet.create({
  ...
  contactsIconBtn: { width: 48, height: 48, borderRadius: 14, backgroundColor: colors.indigoBg, borderWidth: 1, borderColor: colors.indigoBorder, alignItems: 'center', justifyContent: 'center' },
  ...
  chipActive: { backgroundColor: colors.indigoBg, borderColor: colors.indigoBorder },
  ...
  saveBtn: { width: 36, height: 36, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.muted, borderWidth: 1, borderColor: colors.border },
  ...
  eventFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 14, paddingTop: 12, borderTopWidth: 1, borderTopColor: colors.divider },
  ...
  openBtn: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10, backgroundColor: colors.indigoBg, borderWidth: 1, borderColor: colors.indigoBorder },
  ...
  retryBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 18, paddingVertical: 10, borderRadius: 12, backgroundColor: colors.indigoBg, borderWidth: 1, borderColor: colors.indigoBorder, marginTop: 4 },
  ...
  cmAddBtn: { width: 42, height: 42, borderRadius: 12, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' },
  cmSubtitle: { fontSize: 13, fontFamily: 'Inter_400Regular', color: colors.textMuted, marginTop: 4 },
  cmDoneBtn: { margin: 20, backgroundColor: colors.indigoBg, borderRadius: 14, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: colors.indigoBorder },
  cmDoneText: { fontSize: 16, fontFamily: 'Inter_600SemiBold', color: colors.primary },
