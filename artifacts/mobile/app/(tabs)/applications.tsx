...
export default function ApplicationsScreen() {
  ...
  const { profile, applications, addApplication, updateApplication, deleteApplication } = useApp();
    ...
    <View style={[s.screen, { paddingTop: topPad }]}>
      ...
      <View style={s.header}>
        <View>
          ...
          <Text style={s.subtitle}>{applications.length} tracked</Text>
        </View>
        <Pressable
          style={s.addBtn}
        ...
        {filtered.length === 0 ? (
          <View style={s.emptyState}>
            ...
            {!search && statusFilter === 'All' && (
              <>
                <Text style={s.emptySubtitle}>Track your WIL placement applications and stay on top of every opportunity.</Text>
                <Pressable
                  style={s.emptyBtn}
                  onPress={() => setShowAdd(true)}
                  accessibilityRole="button"
        ...
        <KeyboardAvoidingView style={[s.sheet, { backgroundColor: colors.background }]} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
          ...
          <ScrollView contentContainerStyle={s.sheetBody} keyboardShouldPersistTaps="handled">
            ...
            <TextInput
              ...
              placeholder="e.g. WIL Placement – Software Engineering"
              placeholderTextColor={colors.textMuted}
...
const styles = (colors: ReturnType<typeof useColors>) => StyleSheet.create({
  ...
  filterChipActive: { backgroundColor: colors.indigoBg, borderColor: colors.indigoBorder },
  ...
  detailTabActive: { backgroundColor: colors.indigoBg, borderColor: colors.indigoBorder },
